...
fun ReworkTripDetailRoute(
    ...
    ReworkStopEditorSheet(
        ...
        onUseManualEntry = viewModel::onUseManualStopEntryClick,
        onLocationNameChanged = viewModel::onStopLocationNameChanged,
        onCountryChanged = viewModel::onStopCountryChanged,
        onLatitudeChanged = viewModel::onStopLatitudeChanged,
        onLongitudeChanged = viewModel::onStopLongitudeChanged,
